...
const BetaLabel = () => (
  <div className="absolute top-2 right-2 px-1.5 py-0.5 rounded-full bg-blue-500/10 dark:bg-blue-900/10">
    <span className="text-[10px] font-medium text-blue-600 dark:text-blue-300">BETA</span>
  </div>
);
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center space-x-4">
                    {(activeTab || showTabManagement) && (
                      <button
                        onClick={handleBack}
                        className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-blue-500/10 dark:hover:bg-blue-900/10 group transition-all duration-200"
                      >
                          ...
                          {(visibleTabs as TabWithDevType[]).map((tab: TabWithDevType) => (
                            <motion.div key={tab.id} layout variants={itemVariants} className="aspect-[1.5/1]">
                              <TabTile
                                ...
                                className="h-full relative hover:bg-blue-500/10 dark:hover:bg-blue-900/10 !important" // Ajustado com !important para sobrescrever
                              >
