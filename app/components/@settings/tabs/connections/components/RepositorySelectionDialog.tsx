          ...
          >
            <Dialog.Content className="bg-white dark:bg-[#1E1E1E] rounded-lg border border-[#E5E5E5] dark:border-[#333333] shadow-xl">
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="space-y-2 text-sm text-[#111111] dark:text-white">
                      <div className="flex items-center gap-2">
                        <span className="i-ph:files text-blue-500 w-4 h-4" /> {/* Ajustado de purple-500 para blue-500 */}
                        <span>Total Files: {stats.totalFiles}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="i-ph:database text-blue-500 w-4 h-4" /> {/* Ajustado de purple-500 para blue-500 */}
                        <span>Total Size: {formatSize(stats.totalSize)}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="i-ph:code text-blue-500 w-4 h-4" /> {/* Ajustado de purple-500 para blue-500 */}
                        <span>
                          Languages:{' '}
                      ...
                      {stats.hasPackageJson && (
                        <div className="flex items-center gap-2">
                          <span className="i-ph:package text-blue-500 w-4 h-4" /> {/* Ajustado de purple-500 para blue-500 */}
                          <span>Has package.json</span>
                        </div>
                      )}
                      {stats.hasDependencies && (
                        <div className="flex items-center gap-2">
                          <span className="i-ph:tree-structure text-blue-500 w-4 h-4" /> {/* Ajustado de purple-500 para blue-500 */}
              ...
              <div className="border-t border-[#E5E5E5] dark:border-[#333333] p-4 flex justify-end gap-3 bg-[#F9F9F9] dark:bg-[#252525] rounded-b-lg">
                ...
                <button
                  onClick={onConfirm}
                  className="px-4 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors" // Ajustado de purple-500 para blue-500
                >
                  OK
                </button>
              </div>
                  ...
                  {selectedRepository ? (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          onClick={handleImport}
                          className="w-full h-10 px-4 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-all duration-200 flex items-center gap-2 justify-center" // Ajustado de purple-500 para blue-500
                        >
...
function RepositoryCard({ repo, onSelect }: { repo: GitHubRepoInfo; onSelect: () => void }) {
  return (
    <div className="p-4 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] hover:border-blue-500/50 transition-colors"> {/* Ajustado de purple-500 para blue-500 */}
