    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:palette-fill w-4 h-4 text-blue-500" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
        ...
        <div>
          ...
          <select
            ...
            className={classNames(
              ...
              'focus:outline-none focus:ring-2 focus:ring-blue-500/30', /* Ajustado de focus:ring-purple-500/30 para focus:ring-blue-500/30 */
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:clock-fill w-4 h-4 text-blue-500" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:keyboard-fill w-4 h-4 text-blue-500" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
