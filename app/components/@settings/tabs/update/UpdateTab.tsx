  ...
  return (
    <div className="flex flex-col gap-6">
      <motion.div
        ...
        transition={{ duration: 0.3 }}
      >
        <div className="i-ph:arrow-circle-up text-xl text-blue-500" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
        <div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          <div className="i-ph:gear text-blue-500 w-5 h-5" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={classNames(
                ...
                updateSettings.autoUpdate ? 'bg-blue-500' : 'bg-gray-200 dark:bg-gray-700', // Ajustado de bg-purple-500 para bg-blue-500
              )}
            >
              <span
                className={classNames(
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={classNames(
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                updateSettings.notifyInApp ? 'bg-blue-500' : 'bg-gray-200 dark:bg-gray-700', // Ajustado de bg-purple-500 para bg-blue-500
              )}
            >
              <span
                className={classNames(
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="i-ph:arrows-clockwise text-blue-500 w-5 h-5" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
          ...
          <div className="flex items-center gap-2">
            {updateProgress?.details?.updateReady && !updateSettings.autoUpdate && (
              <button
                ...
                className={classNames(
                  ...
                  'bg-blue-500 text-white', // Ajustado de bg-purple-500 para bg-blue-500
                  'hover:bg-blue-600', // Ajustado de hover:bg-purple-600 para hover:bg-blue-600
                  'transition-colors duration-200',
                )}
              >
            ...
            <button
              ...
              className={classNames(
                'flex items-center gap-2 px-4 py-2 rounded-lg text-sm',
                'bg-[#F5F5F5] dark:bg-[#1A1A1A]',
                'hover:bg-blue-500/10 hover:text-blue-500', // Ajustado de hover:bg-purple-500/10 hover:text-purple-500 para hover:bg-blue-500/10 hover:text-blue-500
                'dark:hover:bg-blue-500/20 dark:hover:text-blue-500', // Ajustado de dark:hover:bg-purple-500/20 dark:hover:text-purple-500 para dark:hover:bg-blue-500/20 dark:hover:text-blue-500
                'text-bolt-elements-textPrimary',
                'transition-colors duration-200',
          ...
          <div className="mt-4 text-sm text-bolt-elements-textSecondary">
            ...
            {updateProgress?.details?.additions !== undefined && updateProgress?.details?.deletions !== undefined && (
              <div className="mt-2 flex items-center gap-2">
                <div className="i-ph:git-diff text-blue-500 w-4 h-4" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
        ...
        {updateProgress?.details?.changelog && (
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-2">
              <div className="i-ph:scroll text-blue-500 w-5 h-5" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
            ...
            <div className="mt-4">
                  ...
                  <div className="bg-[#F5F5F5] dark:bg-[#1A1A1A] rounded-lg p-3 space-y-2">
                    {updateProgress.details.commitMessages.map((msg, index) => (
                      <div key={index} className="text-sm text-bolt-elements-textSecondary flex items-start gap-2">
                        <div className="i-ph:git-commit text-blue-500 w-4 h-4 mt-0.5 flex-shrink-0" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
                        <span>{msg}</span>
                      </div>
                    ))}
                  </div>
              ...
              {updateProgress?.details?.totalSize && (
                <div className="flex items-center gap-4 text-sm text-bolt-elements-textSecondary">
                  <div className="flex items-center gap-2">
                    <div className="i-ph:file text-blue-500 w-4 h-4" /> {/* Ajustado de text-purple-500 para text-blue-500 */}
