          ...
          <div className="flex items-center gap-2">
            <div
              className={classNames(
                ...
                'text-blue-500', // Ajustado de text-purple-500 para text-blue-500
              )}
            >
            ...
            >
              <div className="absolute top-0 right-0 p-2 flex gap-1">
                {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                  <motion.span
                    className="px-2 py-0.5 text-xs rounded-full bg-blue-500/10 text-blue-500 font-medium" // Ajustado de bg-purple-500/10 e text-purple-500 para bg-blue-500/10 e text-blue-500
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'transition-all duration-200',
                    provider.settings.enabled ? 'text-blue-500' : 'text-bolt-elements-textSecondary', // Ajustado de text-purple-500 para text-blue-500
                  )}
              ...
              <motion.div
                ...
                animate={{
                  borderColor: provider.settings.enabled ? 'rgba(59, 130, 246, 0.2)' : 'rgba(59, 130, 246, 0)',
