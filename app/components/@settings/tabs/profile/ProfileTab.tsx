          ...
          <div className="flex items-start gap-6 mb-8">
            ...
            >
              {profile.avatar ? (
                ...
                <div className="i-ph:robot-fill w-16 h-16 text-gray-400 dark:text-gray-500 transition-colors group-hover:text-blue-500/70 transform -translate-y-1" /> // Ajustado de purple-500 para blue-500
              )}
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={classNames(
                  ...
                  'focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50', // Ajustado de purple-500 para blue-500
                  'transition-all duration-300 ease-out',
                )}
