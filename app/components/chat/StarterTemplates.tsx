...
const FrameworkLink: React.FC<FrameworkLinkProps> = ({ template }) => (
  ...
  >
    <div
      className={`inline-block ${template.icon} w-8 h-8 text-4xl transition-theme opacity-25 hover:opacity-100 hover:text-blue-500 dark:text-white dark:opacity-50 dark:hover:opacity-100 dark:hover:text-blue-400 transition-all`} // Ajustado de hover:text-purple-500 e dark:hover:text-purple-400 para hover:text-blue-500 e dark:hover:text-blue-400
