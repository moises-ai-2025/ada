  ...
  return (
    <button
      className={classNames('inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm transition-colors', {
        'bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-600': type === 'primary', // Ajustado de purple-500 para blue-500 e purple-600 para blue-600
