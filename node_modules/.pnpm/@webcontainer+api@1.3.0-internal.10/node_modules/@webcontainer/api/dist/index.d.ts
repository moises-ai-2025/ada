 ...
 */
import type { FileSystemTree, AuthAPI, Unsubscribe, PreviewMessage } from './entities.js';
...
export type { DirectoryNode, FileNode, FileSystemTree, AuthAPI, AuthInitOptions, AuthFailedError, Unsubscribe, PreviewMessage, BasePreviewMessage, ConsoleErrorMessage, UncaughtExceptionMessage, UnhandledRejectionMessage, } from './entities.js';
...
export declare class WebContainerInternal {
    ...
    serialize(folder: string, options?: GlobOptions): Promise<Uint8Array>;
}
...
export interface GlobOptions {
    ...
    /** @default json */
    format?: 'pretty' | 'msgpack' | 'json' | 'zip';
}
/**
