...
import { withoutTrailingSlash as withoutTrailingSlash2 } from "@ai-sdk/provider-utils";
...
function createOllama(options = {}) {
  var _a;
  const baseURL = (_a = withoutTrailingSlash2(options.baseURL)) != null ? _a : "http://127.0.0.1:11434/api";
  const getHeaders = () => ({
    ...options.headers
  });
